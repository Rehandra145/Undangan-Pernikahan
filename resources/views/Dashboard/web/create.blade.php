    ...
    <div class="ml-64 flex-1 p-8 overflow-y-auto">
        ...
        <div class="w-[58rem] ml-4 bg-white rounded-xl shadow-lg overflow-hidden p-8"">
            <form action="{{ route('web.store') }}" method="POST" id="form-edit-event">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <!-- Tanggal dan Waktu -->
                    <div>
                        <label for="tanggal" class="block text-gray-700 font-medium">Tanggal dan Waktu</label>
        ...
        <div class="mt-6 flex">
            <button type="submit" form="form-edit-event"
                class="bg-blue-600 text-white py-2 ml-4 px-6 rounded-lg hover:bg-blue-700 transition">
                Kirim
            </button>
        </div>
    </div>
