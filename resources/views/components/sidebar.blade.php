<button id="mobile-menu-button" class="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-md bg-gray-900 text-white">
...
<!-- Sidebar -->
<div id="sidebar" class="w-64 bg-gray-900 text-white flex flex-col shadow-lg lg:static fixed transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 h-screen">
...
<div class="p-4 border-t border-gray-800">
    <form method="POST" action="{{ route('login.logout') }}" class="inline">
        @csrf
        <button type="submit" class="flex items-center space-x-3 text-red-400 hover:text-red-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
<div id="sidebar-overlay" class="lg:hidden fixed inset-0 bg-transparent z-30 hidden"></div>
